...
struct Constants {
    ...
    static let forgotYourPassword = NSLocalizedString("forgotYourPassword", comment: "")
    ...
    static let passwordRecover = NSLocalizedString("passwordRecover", comment: "")
    static let provideYourEmail = NSLocalizedString("provideYourEmail", comment: "")
